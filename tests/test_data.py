...
from lai_textclf.data import IterableTextClfDataset, TextClassificationDataModule, TextEncodingCollate
...
def test_textclassification_datamodule():
    dm = TextClassificationDataModule('IMDB', tokenizer=BoringTokenizer(), max_token_len=512)
...
def test_text_encoding_collate():
    ...
    output = collate([{'text': 'this is cool!', 'label': 3}, {'text': 'this is super cool!', 'label': 5}])
